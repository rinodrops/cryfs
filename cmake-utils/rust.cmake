    ...
    if(TARGET_WANTS_LTO)
        if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" OR "${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang")
            ...
            if ("${_CMAKE_CXX_COMPILER_VERSION_MAJOR}" GREATER_EQUAL 9)
                ...
                message(WARNING "Cross-language LTO disabled because we're on clang version ${_CMAKE_CXX_COMPILER_VERSION_MAJOR} which is too old")
            endif()
        else()
            message(WARNING "Cross-language LTO disabled because we're not using the clang compiler.")
        endif()
    else()
        message(STATUS "Cross-language LTO disabled because the target property INTERPROCEDURAL_OPTIMIZATION is not set on the ${TARGET_NAME} target")
        set(RUST_FLAGS "")
    endif()
